(function (window) {
    ...
    opspark.preload = function (game) {
        ...
        game.load.image('shortplatform', './asset/shortplatform.png');
        ...
        game.load.image('pizza', './asset/collectable/pizza.png');
        game.load.image('puppy', './asset/collectable/puppy.png');         
